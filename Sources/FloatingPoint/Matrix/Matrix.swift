...
public protocol Matrix2<Scalar>: Matrix where
  Columns == Vectuple2<Column>,
  Row == SIMD2<Scalar>
{
...
public protocol Matrix4<Scalar>: Matrix where
  Columns == Vectuple4<Column>,
  Row == SIMD4<Scalar>
{
